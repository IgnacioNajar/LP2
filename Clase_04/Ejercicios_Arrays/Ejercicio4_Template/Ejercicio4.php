<?php
    $miembros_equipo = [
        ...
        "imagen" => "images/team/jhon.png"],
        //Miembro 2
        ["nombre" => "Mary",
        "apellido" => "Thornton",
        "email" => "marythornton@mail.com",
        "imagen" => "images/team/mary.png"],
        //Miembro 3
        ["nombre" => "Kun",
        "apellido" => "Kigo",
        "email" => "kunkigo@mail.com",
        "imagen" => "images/team/kun.png"],
        //Miembro 4
        ["nombre" => "Sue",
        "apellido" => "Wright",
        "email" => "suewright@gmail.com",
        "imagen" => "images/team/sue.png"]
    ];

    $cantidad_miembros = count($miembros_equipo);
?>
                ...
                <table class="table table-sm">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Email</th scope="col">
                            <th scope="col">Imagen</th scope="col">
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($miembros_equipo as $indice => $miembro): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    alt="Imagen de perfil de <?= $miembro["nombre"]?>"
                                    title="Imagen de perfil de <?= $miembro["nombre"]; ?>">
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
