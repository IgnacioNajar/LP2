...
<html>
    ...
    <body>
        ...
        <?php
        $Cadena="        HOLA         ";
        echo 'La variable $Cadena contiene: <pre>['.$Cadena.']</pre>'; //ver codigo fuente
        ?>
        <hr />
        ...
        echo 'La variable limpia desde la izquierda con ltrim($parametro): <pre>'.$Cadena_LimpiaLeft.'</pre>';
        ?>
        <hr />
        ...
        echo 'La variable limpia desde la derecha con rtrim($parametro) : <pre>'.$Cadena_LimpiaRight.'</pre>';
        ?>
        <hr />
        ...
        echo 'La variable limpia der/izq con trim($parametro) : <pre>'.$Cadena_Limpia.'</pre>';
        ?>
        <hr />
        ...
        $Cadena = "          Cuando quieres realmente una cosa, todo el Universo conspira para ayudarte a conseguirla. [Paulo Coelho]        ";
        $Cantidad_Caracteres=strlen($Cadena); //devuelve un entero, la cantidad de caracteres incluidos los espacios
        echo "<i><pre>$Cadena</pre></i>
        Contiene $Cantidad_Caracteres caracteres. <br />";
