...
<html>
    ...
    <body>
        ...
        if (is_integer($Numero)){
            ...
            echo 'La variable $Numero contiene: '.$Numero.' y es un numero ENTERO. <br />';
        }else {
            //Este proceso se ejecuta si $Numero NO es un numero entero.
            echo 'La variable $Numero contiene: '.$Numero.' y NO es un numero ENTERO. <br />';
        }
        /***********************************************************************/
        ?>
        ...
        if (is_float($Numero)){
            ...
            echo 'La variable $Numero contiene: '.$Numero.' y es un numero DECIMAL. <br />';
        }else {
            //Este proceso se ejecuta si $Numero NO es un numero decimal.
            echo 'La variable $Numero contiene: '.$Numero.' y NO es un numero DECIMAL. <br />';
        }
