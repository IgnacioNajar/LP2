<?php
include_once 'array.php'; //aqui se incrusta toooodo el contenido de este script

include_once 'funciones.php';  //aqui se incrusta toooodo el contenido de este otro script
